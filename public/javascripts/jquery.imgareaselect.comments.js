...
$.imgAreaSelect = function (img, options) {
    ...
    function adjust() {
        ...
        /*
         * Workaround for jQuery 1.3.2 offset() bug in WebKit based browsers
         * (jQuery 1.2.6 is fine, and the bug is supposed to be fixed in future
         * versions)
         */
    ...
    /**
     * Adjust the x2/y2 coordinates to maintain aspect ratio (calculate x2
     * first)
     */
    ...
    /**
     * Adjust the x2/y2 coordinates to maintain aspect ratio (calculate y2
     * first)
     */
    ...
    /**
     * Parent element scroll event handler
     */
    ...
    function setOptions(newOptions) {
        ...
        if (newOptions.hide)
            ...
            shown = true;
            //$box.add($outer).css({ visibility: 'hidden' })
            //    .fadeIn(options.fadeSpeed||0).css({ visibility: '' });
